...
np. SELECT zarobki(3750,1.25) AS 'Zarobki pracownika po podwyzce';
...
np. INSERT INTO Kandydatka(Imie, Nazwisko, Data_urodzenia, Telefon, pesel, id_adresu) VALUES 
...
np. INSERT INTO Odcinek(Tytul, Data_publikacji, Godzina_publikacji, id_rolnika, id_kandydatki, id_pracownika) VALUES 
